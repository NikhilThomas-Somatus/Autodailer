/****** Object:  StoredProcedure [dbo].[sp_AutoDialerCampagin]    Script Date: 4/27/2022 12:53:47 PM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT PatientActivityId from PatientActivity where PatientId=@PatientId OR (ActivityId=2297 AND ActivityStatusId = 104 AND IsDeleted = 0)
OR (ActivityId=2298 AND ActivityStatusId = 104 AND IsDeleted = 0)
OR (ActivityId=9755 AND ActivityStatusId = 104 AND IsDeleted = 0)
OR (ActivityId=9756 AND ActivityStatusId = 104 AND IsDeleted = 0)
OR (ActivityId=9757 AND ActivityStatusId = 104 AND IsDeleted = 0))
