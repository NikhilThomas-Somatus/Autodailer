...
select * from ETL_AutoDialer_List_STG
...
or patientid in (select patientid from patienteligibility where activepatient = 0)
or patientstatus like 'Written Consent%'
or patientstatus like 'On Hold%'
or patientstatus like 'Deceased%'
or patientstatus like 'Verbal Consent%'
or patientstatus like 'Reached%' 


UPDATE TASK SET modifiedbyuserid = 1574 
from Task a 
inner join ETL_AutoDialer_List_STG b on a.patientactivityid = b.[patient activity id]
inner join SRC_AutoDialer_PatientStatus c on c.patientid = b.patientid
